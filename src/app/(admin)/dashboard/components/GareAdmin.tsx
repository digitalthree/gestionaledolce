            ...
            <button className="btn btn-outline btn-info mt-10 w-1/2"
                    onClick={() => {
                        let garaToUpdate = {
                            ...
                            fatturatoNonConfermato: inputsGara[3].value,
                            aggiudicazioneInCorso: inputsGara[4].value,
                            gareInScadenza: inputsGara[5].value,
                            gareInCorso: inputsGara[6].value,
                            gareVinte: inputsGara[7].value,
                            garePerse: inputsGara[8].value,
                            gareNuovePartecipate: inputsGara[9].value,
                            gareNuoveVinte: inputsGara[10].value,
                            annoNuovoFatturato: inputsGara[11].value,
                            portafoglioAcquisto: inputsGara[12].value,
                            confermatoDiGara: inputsGara[13].value,
                            prorogato: inputsGara[14].value,
